# Investigate the ch4 molecule
# Plot the overlap and density matrices to third_steps.svg for the individual irreps
...
molecule = [m for m in load_molecules() if m.name() == "ch4"][0]
